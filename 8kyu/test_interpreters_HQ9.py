...
def HQ9(code):
    ...
    for i in range(98, 1, -1):
        lyrics += f'Take one down and pass it around, {i} bottles of beer on the wall.\n'
    ...
    codes = {'H': 'Hello World!', 'Q': code, '9': lyrics}

    return codes.get(code, None)


def test_HQ9():
    assert HQ9('H') == 'Hello World!', '\'H\' should return \'Hello World!\''
    assert HQ9('Q') == 'Q', '\'Q\' should return \'Q\''
    assert HQ9('9') == "99 bottles of beer on the wall, 99 bottles of beer.\nTake one down and pass it around, 98 bottles of beer on the wall.\n" \
        "98 bottles of beer on the wall, 98 bottles of beer.\nTake one down and pass it around, 97 bottles of beer on the wall.\n" \
        "97 bottles of beer on the wall, 97 bottles of beer.\nTake one down and pass it around, 96 bottles of beer on the wall.\n" \
    ...
    assert HQ9('X') == None, "Everything else should not return anything"
