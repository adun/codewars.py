# Create a function close_compare that accepts 3 parameters: a, b, and an optional
# margin. The function should return whether a is lower than, close to, or higher than b.
